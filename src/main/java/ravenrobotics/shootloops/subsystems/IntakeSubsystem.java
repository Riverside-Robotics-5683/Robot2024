...
public class IntakeSubsystem extends SubsystemBase {
    ...
    private final Debouncer distanceFilter = new Debouncer(
        0.1,
        DebounceType.kBoth
    );

    //Shuffleboard
    private final GenericEntry armPositionEntry = Telemetry.teleopTab
        .add("Arm Position", 0)
        .getEntry();
    private final GenericEntry sensorEntry = Telemetry.teleopTab
        .add("Note Sensor", false)
        .getEntry();
